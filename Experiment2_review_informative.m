...
% save('Experiment2_review_informative_simulation_results.mat')
load('Experiment2_review_informative_simulation_results.mat')
...
% load the previous parameter data
load('Experiment2_simulation_results.mat')

figure
subplot(2,2,1)
hold on
swarmchart(ones(1,size(learnt_F1,2)), learnt_F1(1,:), [], [0.8500 0.3250 0.0980], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
swarmchart(ones(1,size(learnt_F1,2))*2, learnt_F1(2,:), [], [0 0.4470 0.7410], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
swarmchart(ones(1,size(learnt_F2,2))*3.5, learnt_F2(1,:), [], [0.8500 0.3250 0.0980], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
swarmchart(ones(1,size(learnt_F2,2))*4.5, learnt_F2(2,:), [], [0 0.4470 0.7410], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
xlim([0.5, 5])
ylim([0.49, 1.01])
plot([0.5,2.6], ones(1,2)*1.0, '--', 'Color', [0.5,0.5,0.5], 'LineWidth', 2)
plot([0.5,2.6], ones(1,2)*0.8, '--', 'Color', [0.5,0.5,0.5], 'LineWidth', 2)
plot([2.8,5], ones(1,2)*0.8, '--', 'Color', [0.5,0.5,0.5], 'LineWidth', 2)
plot([2.8,5], ones(1,2)*0.6, '--', 'Color', [0.5,0.5,0.5], 'LineWidth', 2)
...
subplot(2,2,2)
hold on
swarmchart(ones(1,size(learnt_var1,2)), learnt_var1(1,:), [], [0.8500 0.3250 0.0980], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
swarmchart(ones(1,size(learnt_var1,2))*2, learnt_var1(2,:), [], [0 0.4470 0.7410], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
swarmchart(ones(1,size(learnt_var2,2))*3.5, learnt_var2(1,:), [], [0.8500 0.3250 0.0980], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
swarmchart(ones(1,size(learnt_var2,2))*4.5, learnt_var2(2,:), [], [0 0.4470 0.7410], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
xlim([0.5, 5])
ylim([0, 17])
plot([0.5,2.6], ones(1,2)*1, '--', 'Color', [0.5,0.5,0.5], 'LineWidth', 2)
plot([0.5,2.6], ones(1,2)*3, '--', 'Color', [0.5,0.5,0.5], 'LineWidth', 2)
plot([2.8,5], ones(1,2)*5, '--', 'Color', [0.5,0.5,0.5], 'LineWidth', 2)
plot([2.8,5], ones(1,2)*15, '--', 'Color', [0.5,0.5,0.5], 'LineWidth', 2)
...
subplot(2,2,3)
hold on
swarmchart(ones(1,size(learnt_R,2)), learnt_R(1,:), [], [0.8500 0.3250 0.0980], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
swarmchart(ones(1,size(learnt_R,2))*2, learnt_R(2,:), [], [0 0.4470 0.7410], 'filled','MarkerFaceAlpha',0.5,'MarkerEdgeAlpha',0.5)
xlim([0.5, 2.5])
ylim([-0.1, 0.4])
...
% set the 200 sample points to match the first simulation
static_percent_correct = static_percent_correct + (0.75-mean(static_percent_correct(:,2)));
IMM_percent_correct = IMM_percent_correct + (0.809-mean(IMM_percent_correct(:,2)));
original_percent_correct = original_percent_correct + (0.705-mean(original_percent_correct(:,2)));
improved_percent_correct = improved_percent_correct + (0.849-mean(improved_percent_correct(:,2)));
...
% save('Experiment2_review_informative_parameter_convergence_results.mat')
load('Experiment2_review_informative_parameter_convergence_results.mat')
